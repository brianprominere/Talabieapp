...
import {Container,Header,Left,Button,Icon,Body,Title,Content,Text,Form, Item, Input, Label, Footer,Right,ListItem,CheckBox} from "native-base";
...
class DnFilterPage extends Component {
  render() {
    return (
...
<Form style={styles.formbottom}>
          ...
          <View style={{alignSelf: 'center',marginBottom: 20,marginTop: 25}}>

      <Button small success onPress={() => this.props.navigation.navigate('Start')}>
