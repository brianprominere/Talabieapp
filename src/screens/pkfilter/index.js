...
class PkFilterPage extends Component {
  render() {
    return (
...
<Form style={styles.formbottom}>
          ...
          <Grid style={{width: '98%',marginRight: 'auto', marginLeft: 'auto'}}>
            <Col style={{borderWidth: 1, borderLeftWidth: 0, borderColor: '#ccc',width: '50%',paddingLeft: 5}}>
            ...
            <Col style={{borderWidth: 1, borderLeftWidth: 0, borderRightWidth: 0, borderColor: '#ccc',width: '50%',paddingLeft: 5}}>
            <Item style={{borderBottomWidth: 0,marginLeft: 0}}>            
      ...
      <Button small success onPress={() => this.props.navigation.navigate('PickUp')}>
