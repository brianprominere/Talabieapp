...
import {Container, Header, Content, Text, Body, Title,Left, Right, Button,Icon,Item, Input, Card,CardItem} from "native-base";
  ...
  render() {
    ...
    <StatusBar barStyle="light-content" 
         ...
         <View style={{backgroundColor: '#a9343a'}}>       
           ...
           <CardView title='Pickup' expanded={false} >
        ...
        <View style={{backgroundColor: '#24B400'}}>       
              <View style={{marginTop: 5, width: '95%', alignSelf: 'center'}}>
                <CardView title='Start time 12:30 PM ' expanded={false} >
                  <View style={{width: '100%'}}>
                    <Item style={{backgroundColor: '#41C42C',marginTop: 4, marginBottom: 2,borderBottomWidth: 0}}>
                      ...
                      <Input placeholder='12:30 PM' placeholderTextColor="#fff" style={{color: '#fff',fontSize: 16}}/>
                    ...
                    <Item style={{backgroundColor: '#41C42C',marginTop: 4, marginBottom: 8,borderBottomWidth: 0}}>
                      ...
                      <Input placeholder='10/10/2018' placeholderTextColor="#fff" style={{color: '#fff',fontSize: 16}}/>
                      <Icon active name='angle-down' style={{color: '#FFF',fontSize: 20,marginRight: 15}} />
                    </Item>
