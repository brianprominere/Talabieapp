...
class PkFoodItem extends Component {
   constructor(props) {
    super(props);
    this.state = {
      seg: 1
...
<Row>
<Col style={{ width: '82%' }}>
<Button transparent onPress={() => this.props.navigation.navigate('PkRestaurantPage')}>
...
<Col>
<View>
<Text style={{marginTop: 5, marginBottom: 5,paddingBottom: 10, fontSize: 20, fontWeight: 'bold', borderBottomColor: '#ccc', borderBottomWidth: 1}}>Cheeseburger <Text note>(5-8 Calories)</Text></Text>
</View>
</Col>
</Row>
<Row>
...
<View style={{marginTop: 10, alignItems: 'center'}}>
      ...
      <View>
      <Button transparent full light onPress={() => this.props.navigation.navigate('PkCheckOut')}>
