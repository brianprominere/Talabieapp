...
export default {
  ...
  tabBarActiveTextColor: "#a9343a",
  tabActiveBgColor: "#fff",

  // Header
  toolbarBtnColor: "#fff",
  toolbarDefaultBg: "#a9343a",
  toolbarHeight: 56,
  ...
  // Segment
  segmentBackgroundColor: "#ccc",
  segmentActiveBackgroundColor: "#a9343a",
  ...
  topTabBarBorderColor: "#ccc",
  topTabBarActiveBorderColor: "green",
