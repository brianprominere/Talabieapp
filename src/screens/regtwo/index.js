...
import { Container,Text,Button,Icon,Form, Item, Input, Label,InputGroup, Content } from "native-base";
   ...
   return (
     ...
     <StatusBar hidden={true} />
          ...
          <View style={{width: '83%',alignSelf: 'center'}}>
              <Text style={{color: '#fff',fontSize: 20,marginBottom: 25}}>One more thing!</Text>
          </View>
          <View style={{width: '90%',alignSelf: 'center'}}>
               <Form>
                    <Item stackedLabel style={{marginBottom: 12}}>
                      <Label style={{color: '#ccc'}}>What is your email?</Label>
                      <Input placeholder="" placeholderTextColor="#aaa"/>
                    </Item>
                    <Item stackedLabel>
                      <Label style={{color: '#ccc'}}>Create Password</Label>
                        <View style={{flexDirection: 'row'}}>
                            <Input placeholder="" placeholderTextColor="#aaa"/>
                            <Button transparent><Icon name="eye" style={{color:'#fff',fontSize: 18}}/></Button>
                        </View>
                    </Item>
                </Form>
          </View>
